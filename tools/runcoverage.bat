...
OpenCover\tools\OpenCover.Console.exe -oldStyle -register:user "-target:%cwd%\runtests.bat" "-filter:+[ConnectQl*]* -[*Tests*]*" "-output:artifacts\ConnectQl.Coverage.xml" -returntargetcode
