# AsyncEnumerableExtensions.ForEachBatchAsync(*TItem*) Method (IAsyncEnumerable(*TItem*), Func(IEnumerable(*TItem*), Task))
...
public static Task ForEachBatchAsync<TItem>(
	...
	Func<IEnumerable<TItem>, Task> action
)
