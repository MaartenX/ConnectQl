# ExpressionExtensions.EvalExpression Method 
...
**C#**<br />
``` C#
public static ConstantExpression EvalExpression(
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/bb338985" target="_blank">ConstantExpression</a><br />The <a href="http://msdn2.microsoft.com/en-us/library/bb356138" target="_blank">Expression</a>.
