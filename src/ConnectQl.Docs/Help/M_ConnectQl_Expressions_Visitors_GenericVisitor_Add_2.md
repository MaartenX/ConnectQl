# GenericVisitor.Add Method (Func(LabelTarget, LabelTarget))
...
public GenericVisitor Add(
	Func<LabelTarget, LabelTarget> labelTarget
)
```


#### Parameters
&nbsp;<dl><dt>labelTarget</dt><dd>Type: <a href="http://msdn2.microsoft.com/en-us/library/bb549151" target="_blank">System.Func</a>(<a href="http://msdn2.microsoft.com/en-us/library/dd268061" target="_blank">LabelTarget</a>, <a href="http://msdn2.microsoft.com/en-us/library/dd268061" target="_blank">LabelTarget</a>)<br />The label target.</dd></dl>
