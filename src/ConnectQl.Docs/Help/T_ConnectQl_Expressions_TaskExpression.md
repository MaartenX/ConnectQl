...
The TaskExpression type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_ConnectQl_Expressions_TaskExpression__ctor">TaskExpression</a></td><td>
Initializes a new instance of the TaskExpression class.</td></tr></table>&nbsp;
<a href="#taskexpression-class">Back to Top</a>
...
Rewrites TaskExpressions to an async expression (if needed).
