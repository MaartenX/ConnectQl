# MaterializationPolicyExtensions.CreateAsyncEnumerableAndRunOnce(*T*, *TState*) Method (IMaterializationPolicy, Func(Task(*TState*)), Func(*TState*, IEnumerable(*T*)), Action(*TState*))
