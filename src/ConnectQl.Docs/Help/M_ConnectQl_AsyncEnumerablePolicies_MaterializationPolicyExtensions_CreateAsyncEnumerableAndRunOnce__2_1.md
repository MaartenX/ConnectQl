# MaterializationPolicyExtensions.CreateAsyncEnumerableAndRunOnce(*T*, *TState*) Method (IMaterializationPolicy, Func(Task(*TState*)), Func(*TState*, Task(IEnumerable(*T*))), Action(*TState*))
