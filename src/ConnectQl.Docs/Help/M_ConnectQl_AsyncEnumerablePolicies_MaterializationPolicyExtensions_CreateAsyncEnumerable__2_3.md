# MaterializationPolicyExtensions.CreateAsyncEnumerable(*T*, *TState*) Method (IMaterializationPolicy, Func(*TState*), Func(*TState*, Task(*T*)), Action(*TState*))
