# MaterializationPolicyExtensions.CreateAsyncEnumerable(*T*, *TState*) Method (IMaterializationPolicy, Func(*TState*), Func(*TState*, Task(IEnumerable(*T*))), Action(*TState*))
