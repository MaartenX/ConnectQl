# ExpressionExtensions.SimplifyRanges Method 
...
**C#**<br />
``` C#
public static Expression SimplifyRanges(
...
#### Parameters
&nbsp;<dl><dt>source</dt><dd>Type: <a href="http://msdn2.microsoft.com/en-us/library/bb356138" target="_blank">System.Linq.Expressions.Expression</a><br />The source expression.</dd></dl>
