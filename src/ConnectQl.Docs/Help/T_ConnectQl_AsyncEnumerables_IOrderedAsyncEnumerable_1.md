# IOrderedAsyncEnumerable(*TElement*) Interface
...
#### Type Parameters
&nbsp;<dl><dt>TElement</dt><dd>The type of the elements in the enumerable.</dd></dl>&nbsp;
The IOrderedAsyncEnumerable(TElement) type exposes the following members.
...
<a href="#iorderedasyncenumerable(*telement*)-interface">Back to Top</a>

## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_ConnectQl_AsyncEnumerables_IOrderedAsyncEnumerable_1_CreateOrderedAsyncEnumerable__1">CreateOrderedAsyncEnumerable(TKey)</a></td><td>
Performs a subsequent ordering on the elements of an IOrderedAsyncEnumerable(TElement) according to a key.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_ConnectQl_AsyncEnumerables_IAsyncEnumerable_1_GetAsyncEnumerator">GetAsyncEnumerator</a></td><td>
Gets an enumerator that returns batches of elements.
 (Inherited from <a href="T_ConnectQl_AsyncEnumerables_IAsyncEnumerable_1">IAsyncEnumerable(T)</a>.)</td></tr></table>&nbsp;
<a href="#iorderedasyncenumerable(*telement*)-interface">Back to Top</a>
