# GenericVisitor.Add Method (Func(MemberMemberBinding, MemberMemberBinding))
...
public GenericVisitor Add(
	Func<MemberMemberBinding, MemberMemberBinding> memberMemberBinding
)
```


#### Parameters
&nbsp;<dl><dt>memberMemberBinding</dt><dd>Type: <a href="http://msdn2.microsoft.com/en-us/library/bb549151" target="_blank">System.Func</a>(<a href="http://msdn2.microsoft.com/en-us/library/bb347918" target="_blank">MemberMemberBinding</a>, <a href="http://msdn2.microsoft.com/en-us/library/bb347918" target="_blank">MemberMemberBinding</a>)<br />The member member binding.</dd></dl>
