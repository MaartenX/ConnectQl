# IFunctionRegistration7 Interface
...
**C#**<br />
``` C#
public interface IFunctionRegistration7 : IConnectQlFunctions
```

The IFunctionRegistration7 type exposes the following members.
...
<a href="#ifunctionregistration7-interface">Back to Top</a>
...
Adds a key/value pair of key'1 => function to the dictionary.
 (Inherited from <a href="T_ConnectQl_Interfaces_IConnectQlFunctions">IConnectQlFunctions</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_ConnectQl_Interfaces_IFunctionRegistration7_SetDescription">SetDescription</a></td><td>
