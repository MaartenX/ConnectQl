# IFunctionRegistration4 Interface
...
**C#**<br />
``` C#
public interface IFunctionRegistration4 : IConnectQlFunctions
```

The IFunctionRegistration4 type exposes the following members.
...
<a href="#ifunctionregistration4-interface">Back to Top</a>
...
Adds a key/value pair of key'1 => function to the dictionary.
 (Inherited from <a href="T_ConnectQl_Interfaces_IConnectQlFunctions">IConnectQlFunctions</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_ConnectQl_Interfaces_IFunctionRegistration4_SetDescription">SetDescription</a></td><td>
